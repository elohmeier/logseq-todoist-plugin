...
export const callSettings = async (projects: string[], labels: string[]) => {
  const settings: SettingSchemaDesc[] = [
    ...
    },
    {
      ...
      description: "If set to true, all tasks sent to Todoist will have the Logseq URI appended.",
    },
    {
      ...
      description: "Adds the current page name to the task description to preserve context inside Todoist.",
    },
    {
      key: "",
      type: "heading",
    ...
    },
    {
      ...
      description: "If true, tasks will be added under a parent block with their project name.",
    },
    {
      ...
      default: true,
      title: "Append TODO",
      description: "If set to true, all retrieved tasks will have a TODO appended.",
    },
    {
      ...
      description: "If set to true, all retrieved tasks will have their todoistId appended.",
    },
    {
      ...
      default: false,
      title: "Append URL",
      description: "If set to true, all retrieved tasks will have a Todoist URL appended.",
    },
    {
      ...
      description: "If set to true, retrieved tasks will be deleted in Todoist.",
    },
    {
      ...
      description: "If set to true, all retrieved tasks will have their creation date and time appended.",
    },
    {
      ...
      description: "If set to true, all retrieved tasks will have their tags appended.",
    },
  ];
